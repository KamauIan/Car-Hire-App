...
Route::get('/admin/pricing_model/{pricing_model}/delete', 'AdminController@deletePrice_model');
...
Route::post('admin/add_pricing_model','AdminController@AddPricing_model');

Route::get('myListings','ListingController@myListing');

Route::get('/admin/reports','AdminController@report');

Route::get('/admin/reports/user','AdminController@users_report');

Route::get('/admin/reports/listings','AdminController@listing_report');

Route::get('/admin/reports/location','AdminController@location_report');

Route::get('/admin/reports/category','AdminController@category_report');
